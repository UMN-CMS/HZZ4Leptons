...
#define NSlices   66  // Number of slices  Corresponding to 1000GeV
//#define NSlices   61  //54 // # of slices in log(A) // Chanage number of Slices to be e3qual to variable width.
#define LogStep 0.05 // size of Slices log(A)

// define Radius of EE in cm  and Speed of light
// Assuming that all particle emerge from  Nominal IP

#define R    315
#define c    29979245800

// Have to define Photon Variables here!
...
// -------- Globals ----------------------------------------
EcalTimeTreeContent treeVars_;  // for Normal Analysis
//EcalTimePhyTreeContent treeVars_; // For GBSM Analysis 
TFile* saving_;
...
int    AoSigmaMax_       = 4000;   //up to about 8 GeV ?? why this maximum?  we can go beyond gain 12-Gain 6 transition.
...
// Adding cases for endcap

TH2F *  timeVsAoSigmaEBlog_;
TH2F *  timeVsAoSigmaEElog_;
...
// Adding for EE and EB.
TH1F*   timeVsAoSigmaEBSlices_[NSlices]; 
TH1F*   timeVsAoSigmaEESlices_[NSlices]; 
...
// TProfile*   fittedMeanVsAoSigmaMod1EB_;
// TProfile*   fittedMeanVsAoSigmaMod2EB_;
// TProfile*   fittedMeanVsAoSigmaMod3EB_;
// TProfile*   fittedMeanVsAoSigmaMod4EB_;
// TProfile*   fittedMeanVsAoSigmaLowEE_; 
// TProfile*   fittedMeanVsAoSigmaHighEE_;
// TProfile*   fittedMeanVsAoSigmaEBlog_;
// TProfile*   fittedMeanVsAoSigmaEElog_;
// TProfile*   fittedRMSVsAoSigmaMod1EB_;
// TProfile*   fittedRMSVsAoSigmaMod2EB_;
// TProfile*   fittedRMSVsAoSigmaMod3EB_;
// TProfile*   fittedRMSVsAoSigmaMod4EB_;
// TProfile*   fittedRMSVsAoSigmaLowEE_;
// TProfile*   fittedRMSVsAoSigmaHighEE_;
// TProfile*   fittedRMSVsAoSigmaEBlog_;
// TProfile*   fittedRMSVsAoSigmaEElog_;
...
TH1D*   fittedRMSVsAoSigmaEB_;
TH1D*   fittedRMSVsAoSigmaEE_;
TH1D*   fittedAreaVsAoSigmaEB_;
TH1D*   fittedAreaVsAoSigmaEE_;


// TProfile*   fittedMeanVsAoSigmaEB_;
// TProfile*   fittedMeanVsAoSigmaEE_;
// TProfile*   fittedRMSVsAoSigmaEB_;
// TProfile*   fittedRMSVsAoSigmaEE_;



//Test JetSeedTime Weighted with TimeResolution
TH1F* Jet1timeEB;
TH1F* Jet1timeEE;
...
// // TimeVsAoSigmaForRings
// TH2F*   timeVsAoSigmaRingX_; // 1.6 < AbsEta < 1.8
// TH2F*   timeVsAoSigmaRingY_; // 2.1 < AbsEta < 2.3
// TH2F*   timeVsAoSigmaRingZ_; // 2.7< AbsEta < 2.9

// // Number of crystals in Rings
// TH1F* nCrysInRingX;
// TH1F* nCrysInRingY;
// TH1F* nCrysInRingZ;

// TH2F* timeVsnVerticesEB;
// TH2F* timeVsnVerticesEEM;
// TH2F* timeVsnVerticesEEP;
...
//   xtalIYHist_ = new TH1F("xtalIY","iy of crystal",101,1,101);
  ...
  CrysTimeVsEta = new TH2F("CrysTimeVsEta"," Crystal Time Vs Eta",500,-2.5,2.5,171,-3.5, 3.5);
  CrysAmpliVsEta= new TH2F(" CrysAmpliVsEta","Crystal Amplitude Vs Eta",100, 0,50000000, 171, -3.5,3.5);
  CrysChi2VsEta= new TH2F(" CrysChi2VsEta", "Crystal Chi-squared Vs Eta",500,-25,25,171,-3.5,3.5);
  CrysChi2VsAmpli= new TH2F(" CrysChi2VsAmpli", "Crystal Chi-squared Vs Amplitude",500,-25,25,100,0,50000000);
  CrysTimeVsPhi=new TH2F(" CrysTimeVsPhi", "Crysal Time Vs Phi",500, -2.5, 2.5, 360, 0,360);
  CrysTimeVsChi2=new TH2F(" CrysTimeVsChi2","Crystal Time Vs #chi^2",500,-2.5,2.5,500,-25,25);
...
//   BCClusterShapeEEPHist_ = new TH1F("EEP cluster shape","e2x2 / e3x3",60,-0.1,1.2);
//   BCClusterShapeEEMHist_ = new TH1F("EEM cluster shape","e2x2 / e3x3",60,-0.1,1.2);
//   BCClusterShapeEBHist_  = new TH1F("EB cluster shape","e2x2 / e3x3",60,-0.1,1.2);
...
// Trying JetTime In BC:
  Jet1timeEB = new TH1F("Jet1timeEB","1st Jet BC in EB TimeDistrubution Weighted with Time Res",50, -2.5,2.5);
  Jet1timeEE = new TH1F("Jet1timeEE","1st Jet BC in EE TimeDistrubution Weighted with Time Res",50, -2.5,2.5);

  // EB and EE time vs A/sigma in modules
  timeVsAoSigmaEB_ = new TH2F("timeVsAoSigmaEB","timeVsAoSigmaEB",100,0,400000,50,-2.5,2.5);
  timeVsAoSigmaEE_ = new TH2F("timeVsAoSigmaEE","timeVsAoSigmaEE",100,0,400000,50,-2.5,2.5);
  //EB modules time vs A/sigma
  timeVsAoSigmaMod1EB_ = new TH2F("timeVsAoSigmaMod1EB","timeVsAoSigmaMod1EB",100,0,400000,50,-2.5,2.5);
  timeVsAoSigmaMod2EB_ = new TH2F("timeVsAoSigmaMod2EB","timeVsAoSigmaMod2EB",100,0,400000,50,-2.5,2.5);
  timeVsAoSigmaMod3EB_ = new TH2F("timeVsAoSigmaMod3EB","timeVsAoSigmaMod3EB",100,0,400000,50,-2.5,2.5);
  timeVsAoSigmaMod4EB_ = new TH2F("timeVsAoSigmaMod4EB","timeVsAoSigmaMod4EB",100,0,400000,50,-2.5,2.5);
  //log E version for EB


        const Int_t nbins = 66; // if You want Maximum Energy to be 1000 GeV if the first Slice is to Have Energy 0.5Gev and Slice width of 10^.05 = 1.122
  //    const Int_t nbins = 100;   // If You want Max Ampli in ADC to be 100000

  
    
    Double_t xmin = pow(10,-0.3); // ~0.5 This is Madness!!!
...
//    std:: cout << "Hello can you see me\n";
     ...
     for(int i=0; i<=nbins;  i++){ 
          ...
          xbins[i] = xmin*pow(10,0.05*i);

//     std:: cout << " These are the Values of array "<< xbins[i] << std::endl;
    };

  timeVsAoSigmaMod1EBlog_ = new TH2F("timeVsAoSigmaMod1EBlog","timeVsAoSigmaMod1EBlog",nbins,xbins,200,-25,25);
  timeVsAoSigmaMod2EBlog_ = new TH2F("timeVsAoSigmaMod2EBlog","timeVsAoSigmaMod2EBlog",nbins,xbins,200,-25,25);
  timeVsAoSigmaMod3EBlog_ = new TH2F("timeVsAoSigmaMod3EBlog","timeVsAoSigmaMod3EBlog",nbins,xbins,200,-25,25);
  timeVsAoSigmaMod4EBlog_ = new TH2F("timeVsAoSigmaMod4EBlog","timeVsAoSigmaMod4EBlog",nbins,xbins,200,-25,25);

 //  // Profiling here!
//  fittedMeanVsAoSigmaEB_= new TProfile("fittedMeanVsAoSigmaEB_","fittedMeanVsAoSigmaEB_",nbins,xbins);
//  fittedMeanVsAoSigmaEE_ = new TProfile("fittedMeanVsAoSigmaEE_","fittedMeanVsAoSigmaEE_",nbins,xbins);
//  fittedRMSVsAoSigmaEB_= new TProfile("fittedRMSVsAoSigmaEB_","fittedRMSVsAoSigmaEB_",nbins,xbins);
//  fittedRMSVsAoSigmaEE_= new TProfile("fittedRMSVsAoSigmaEE_","fittedRMSVsAoSigmaEE_",nbins,xbins);

//   fittedMeanVsAoSigmaMod1EB_= new TProfile("fittedMeanVsAoSigmaMod1EB_","fittedMeanVsAoSigmaMod1EB_",nbins,xbins);
//   fittedMeanVsAoSigmaMod2EB_= new TProfile("fittedMeanVsAoSigmaMod2EB_","fittedMeanVsAoSigmaMod2EB_",nbins,xbins);
//   fittedMeanVsAoSigmaMod3EB_= new TProfile("fittedMeanVsAoSigmaMod3EB_","fittedMeanVsAoSigmaMod3EB_",nbins,xbins);
//   fittedMeanVsAoSigmaMod4EB_= new TProfile("fittedMeanVsAoSigmaMod4EB_","fittedMeanVsAoSigmaMod4EB_",nbins,xbins);
//   fittedMeanVsAoSigmaLowEE_= new TProfile("fittedMeanVsAoSigmaLowEE_","fittedMeanVsAoSigmaLowEE_",nbins,xbins); 
//   fittedMeanVsAoSigmaHighEE_= new TProfile("fittedMeanVsAoSigmaHighEE_","fittedMeanVsAoSigmaHighEE_",nbins,xbins);
//   fittedMeanVsAoSigmaEBlog_ = new TProfile("fittedMeanVsAoSigmaEBlog_","fittedMeanVsAoSigmaEBlog_",nbins,xbins); 

//   fittedMeanVsAoSigmaEElog_= new TProfile("fittedMeanVsAoSigmaEElog_","fittedMeanVsAoSigmaEElog_",nbins,xbins);
//    fittedRMSVsAoSigmaMod1EB_= new TProfile("fittedRMSVsAoSigmaMod1EB_","fittedRMSVsAoSigmaMod1EB_",nbins,xbins);
//    fittedRMSVsAoSigmaMod2EB_= new TProfile("fittedRMSVsAoSigmaMod2EB_","fittedRMSVsAoSigmaMod2EB_",nbins,xbins);
//    fittedRMSVsAoSigmaMod3EB_= new TProfile("fittedRMSVsAoSigmaMod3EB_","fittedRMSVsAoSigmaMod3EB_",nbins,xbins);
//    fittedRMSVsAoSigmaMod4EB_= new TProfile("fittedRMSVsAoSigmaMod4EB_","fittedRMSVsAoSigmaMod4EB_",nbins,xbins);
//    fittedRMSVsAoSigmaLowEE_= new TProfile("fittedRMSVsAoSigmaLowEE_","fittedRMSVsAoSigmaLowEE_",nbins,xbins);
//    fittedRMSVsAoSigmaHighEE_= new TProfile("fittedRMSVsAoSigmaHighEE_","fittedRMSVsAoSigmaHighEE_",nbins,xbins);
//    fittedRMSVsAoSigmaEBlog_= new TProfile("fittedRMSVsAoSigmaEBlog_","fittedRMSVsAoSigmaEBlog_",nbins,xbins);
//    fittedRMSVsAoSigmaEElog_= new TProfile("fittedRMSVsAoSigmaEElog_","fittedRMSVsAoSigmaEElog_",nbins,xbins);



  // adding for EB and EE whole:

 timeVsAoSigmaEBlog_ = new TH2F("timeVsAoSigmaEBlog","timeVsAoSigmaEBlog",nbins,xbins,200,-25,25);
 timeVsAoSigmaEElog_ = new TH2F("timeVsAoSigmaEElog","timeVsAoSigmaEElog",nbins,xbins,200,-25,25);
  //EE time vs A/sigma
  ...
  //EE time vs A/sigma
  timeVsAoSigmaLowEE_ = new TH2F("timeVsAoSigmaLowEE","timeVsAoSigmaLowEE",100,0,40000,50,-2.5,2.5);
  timeVsAoSigmaHighEE_ = new TH2F("timeVsAoSigmaHighEE","timeVsAoSigmaHighEE",100,0,40000,50,-2.5,2.5);
  //EE time vs A/sigma in log
  timeVsAoSigmaLowEElog_ = new TH2F("timeVsAoSigmaLowEElog","timeVsAoSigmaLowEElog",nbins,xbins,200,-25,25);
  timeVsAoSigmaHighEElog_ = new TH2F("timeVsAoSigmaHighEElog","timeVsAoSigmaHighEElog",nbins,xbins,200,-25,25);
  ...
  timeVsAoSigmaEBlarge_ = new TH2F("timeVsAoSigmaEBlarge","timeVsAoSigmaEB",200,0,80000,150,-25,25);
  timeVsAoSigmaEElarge_ = new TH2F("timeVsAoSigmaEElarge","timeVsAoSigmaEE",200,0,80000,150,-25,25);

 timeVsAoSigmaEBlargelog_ = new TH2F("timeVsAoSigmaEBlargelog","timeVsAoSigmaEBlog",nbins,xbins,150,-25,25);
  timeVsAoSigmaEElargelog_ = new TH2F("timeVsAoSigmaEElargelog","timeVsAoSigmaEElog",nbins,xbins,150,-25,25);

  //  std::cout << " I want to know if here?" << std::endl;
 ...
 //-------- Adding Slices of EB and EE whole --------------------
  timeVsAoSigmaEBSlices_[0] = new TH1F("AEB slice 1: 0-0.50 GeV","AEBSlice 0-0.50",200,-25,25);
  timeVsAoSigmaEESlices_[0] = new TH1F("AEE slice 1: 0-0.50 GeV","AEESlice 0-0.50",200,-25,25);

  float binAoSigmaLow; float binAoSigmaHigh;

  binAoSigmaHigh = pow(10,-0.3); // pow(10,-0.3)= 0.50
  //  binAoSigmaHigh = pow(10,0);

//  std::cout << " let me Know if Here!" << std::endl;

  for(int v=1; v<NSlices-1; v++){

    binAoSigmaLow  = binAoSigmaHigh;
    //    binAoSigmaHigh =v*pow(10,LogStep);
    ...
    //    std::cout << binAoSigmaLow << " And High is" <<  binAoSigmaHigh << std::endl;
    ...
    //-----------------------Filling EE and EB ALL slices------------------------//
    sprintf (buffer_, "AEB slice %d: [%5.1f,%5.1f) GeV", v+1, binAoSigmaLow, binAoSigmaHigh);
    timeVsAoSigmaEBSlices_[v] = new  TH1F(buffer_,buffer_,200,-25,25);

    sprintf (buffer_, "AEE slice %d: [%5.1f,%5.1f) GeV", v+1, binAoSigmaLow, binAoSigmaHigh);
    timeVsAoSigmaEESlices_[v] = new  TH1F(buffer_,buffer_,200,-25,25); 
    ...
    //---------------------_Adding EE and EB whole SLices ------------------///

    sprintf (buffer_, "AEB slice %2i: [%5.1f)", NSlices, binAoSigmaLow);
    timeVsAoSigmaEBSlices_[NSlices-1] = new  TH1F(buffer_,buffer_,200,-25,25); 
    sprintf (buffer_, "AEE slice %2i: [%5.1f)", NSlices, binAoSigmaLow);
    timeVsAoSigmaEESlices_[NSlices-1] = new  TH1F(buffer_,buffer_,200,-25,25); 
...
//     //    float binLeft=(v*AeffMax_/AeffNBins_); float binRight=((v+1)*AeffMax_/AeffNBins_);//
//     float binLeft=AeffBins_[v]; float binRight=AeffBins_[v+1];
...
//   // Study the Eta or Ring dependence
//  timeVsAoSigmaRingX_= new TH2F("timeVsAoSigmaRingX_","timeVsAoSigmaRing 1.6<|#eta|<1.8",500,-25,25,100,0,4000);
//  timeVsAoSigmaRingY_= new TH2F("timeVsAoSigmaRingY_","timeVsAoSigmaRing 2.1<|#eta|<2.3",500,-25,25,100,0,4000);
//  timeVsAoSigmaRingZ_= new TH2F("timeVsAoSigmaRingZ_","timeVsAoSigmaRing 2.7<|#eta|<2.9",500,-25,25,100,0,4000);
 
//  // Number of crystals in Rings
//  nCrysInRingX = new TH1F("nCrysInRingX","Number Of Crystal in 1.6<|#eta|<1.8",10,0,100);
//  nCrysInRingY = new TH1F("nCrysInRingY","Number Of Crystal in 2.1<|#eta|<2.3",10,0,100);
//  nCrysInRingZ = new TH1F("nCrysInRingZ","Number Of Crystal in 2.7<|#eta|<2.9",10,0,100);

//   // 2D to study timeVsnVertices on Timing Resolution
//     timeVsnVerticesEB = new TH2F("timeVsnVerticesEB", "CrystlTime Vs Number of Vertices", 500, -25, 25, 10, -1.0, 50);
//     timeVsnVerticesEEP = new TH2F("timeVsnVerticesEEP", "CrystlTime Vs Number of Vertices", 500, -25, 25, 10, -1.0, 50);
//     timeVsnVerticesEEM = new TH2F("timeVsnVerticesEEM", "CrystlTime Vs Number of Vertices", 500, -25, 25, 10, -1.0, 50);
 
//     // std::cout << "  haha Not even here!" << std::endl;


   }//end initializeHists


// //---------------------------------------------------------------------------------------Boolean Fxn to Test SC/C belonging to Object-----------------------------

//  bool JetMatched ( int bClusterIndex )
//  { // Is  SC/Cluster Matched?


//    if (( treeVars_.SCPIdx[bClusterIndex]=100  &&   treeVars_.CPIdx[bClusterIndex]   &&   treeVars_.clusterMom[bClusterIndex]=1))
// 	{ 
//            return true;
// 	}
//       else
// { return  false;
//   std::cout << "No Jet SC or C found" << std::endl;
// }

//  } // End of Boolean Test SC/C to Phys Object Fxn
...
ClusterTime timeAndUncertSingleCluster(int bClusterIndex)
{
 ...
 //     // Is SC/C Matched to PhysObject?
//     //  if( treeVars_.SCPIdx[bClusterIndex]=100  &&   treeVars_.CPIdx[bClusterIndex]=100   &&   treeVars_.clusterMom[bClusterIndex]=1 );
//   bool IsJet = false;
//   if ( (treeVars_.SCPIdx[bClusterIndex]=100)  &&   (treeVars_.CPIdx[bClusterIndex]=100)   &&   (treeVars_.clusterMom[bClusterIndex]=1) ) IsJet = true;
...
//   float myTime = weightTsum/weightSum; 

//   if (thisIsInEB) 
//     {
//     Jet1timeEB->Fill(myTime);
//     }
//   else 
//     {
//       Jet1timeEE->Fill(myTime);
//     }

  }   //end of loop over crys
...
//       eBC+= treeVars_.xtalInBCEnergy[bCluster][cryInBC];
      ...
      CrysTimeVsEta->Fill(treeVars_.xtalInBCTime[bCluster][cryInBC],treeVars_.clusterEta[bCluster]);
      //       CrysTimeVsEta->Fill(treeVars_.xtalInBCTime[bCluster][cryInBC],treeVars_.xtalInBCEta[bCluster][cryInBC]);
           CrysAmpliVsEta->Fill(treeVars_.xtalInBCAmplitudeADC[bCluster][cryInBC], treeVars_.clusterEta[bCluster]);
	   //     CrysAmpliVsEta->Fill(treeVars_.xtalInBCAmplitudeADC[bCluster][cryInBC], treeVars_.xtalInBCEta[bCluster][cryInBC]);
       CrysChi2VsEta->Fill(treeVars_.xtalInBCChi2[bCluster][cryInBC],treeVars_.clusterEta[bCluster]);
       CrysChi2VsAmpli->Fill(treeVars_.xtalInBCChi2[bCluster][cryInBC],treeVars_.xtalInBCAmplitudeADC[bCluster][cryInBC]);
       CrysTimeVsPhi->Fill(treeVars_.xtalInBCTime[bCluster][cryInBC],treeVars_.clusterPhi[bCluster]);
       CrysTimeVsChi2->Fill(treeVars_.xtalInBCTime[bCluster][cryInBC],treeVars_.xtalInBCChi2[bCluster][cryInBC]);
...
//   xtalIYHist_ ->Write();
   ...
   // Crystal Ampli Dependence per Crystal Check
//   CrysTimeVsEta->GetXaxis()->SetTitle("Time[ns]");  
//   CrysTimeVsEta->GetYaxis()->SetTitle("#eta"); 
//   CrysTimeVsEta->Write();

//   CrysAmpliVsEta->GetXaxis()->SetTitle("Amplitude[ADC Counts]");  
//   CrysAmpliVsEta->GetYaxis()->SetTitle("#eta"); 
//   CrysAmpliVsEta->Write();
...
// Trying Weighted Jet Time

  Jet1timeEB->GetXaxis()->SetTitle("JetTime[ns]");
  Jet1timeEB->GetYaxis()->SetTitle("Entries");
  Jet1timeEB->Write();

  Jet1timeEE->GetXaxis()->SetTitle("JetTime[ns]");
  Jet1timeEE->GetYaxis()->SetTitle("Entries");
  Jet1timeEE->Write();

  // My Graph Here!
  Tgraph->Write();
 Tgraph->GetXaxis()->SetTitle("Energy(GeV)");
 Tgraph->GetYaxis()->SetTitle("MeanTime (ns)");
   ...
   CrysAmpliVsEta->GetXaxis()->SetTitle("Energy");  
   CrysAmpliVsEta->GetYaxis()->SetTitle("#eta"); 
   CrysAmpliVsEta->Write();
   // Crystal chi-square
   CrysChi2VsEta->GetXaxis()->SetTitle("Chi2");
   CrysChi2VsEta->GetYaxis()->SetTitle("#eta");
   CrysChi2VsEta->Write();
   
   //     CrysChi2VsEta->Fill(treeVars_.xtalInBCChi2[bCluster][cryInBC],treeVars_.xtalInBCEta[bCluster][cryInBC]);
   //     CrysChi2VsAmpli->Fill(treeVars_.xtalInBCChi2[bCluster][cryInBC],treeVars_.xtalInBCAmplitudeADC[bCluster][cryInBC]);
       CrysChi2VsAmpli->GetXaxis()->SetTitle("Chi2");
       CrysChi2VsAmpli->GetYaxis()->SetTitle("Energy");
       CrysChi2VsAmpli->Write();
      
       //CrysTimeVsAMpli
       CrysTimeVsPhi->GetXaxis()->SetTitle("Time[ns]");
       CrysTimeVsPhi->GetYaxis()->SetTitle("#phi");
       CrysTimeVsPhi->Write();
       //CrysTimeVsChi2
       CrysTimeVsChi2->GetXaxis()->SetTitle("Time[ns]");
       CrysTimeVsChi2->GetYaxis()->SetTitle("#chi^2");
       CrysTimeVsChi2->Write();
  ...
  //adding for EB and EE
 timeVsAoSigmaEBlog_->Write();
 timeVsAoSigmaEElog_->Write();
  ...
  //--------------------Doing Same for  all of EE and EB-------------//
  ...
  //--------------------- Doing for ALL EE and EB-------//
  fittedRMSVsAoSigmaEB_->Write();
  fittedRMSVsAoSigmaEE_->Write();
...
//   fittedAreaVsAoSigmaMod4EB_->Write();
  ...
  // Doing same for EE and EB----------------------//
//   fittedAreaVsAoSigmaEB_->Write();
//   fittedAreaVsAoSigmaEE_->Write();
...
//   timeVsAoSigmaRingX_->GetXaxis()->SetTitle("Time[ns]");
//   timeVsAoSigmaRingX_->GetYaxis()->SetTitle("A/#sigma_{n}");
//   timeVsAoSigmaRingX_->Write();
//   timeVsAoSigmaRingY_->GetXaxis()->SetTitle("Time[ns]");
//   timeVsAoSigmaRingY_->GetYaxis()->SetTitle("A/#sigma_{n}");
//   timeVsAoSigmaRingY_->Write();
//   timeVsAoSigmaRingZ_->GetXaxis()->SetTitle("Time[ns]");
//   timeVsAoSigmaRingZ_->GetYaxis()->SetTitle("A/#sigma_{n}");
//   timeVsAoSigmaRingZ_->Write();
  
//   // Number of Crystals in Ring
//   nCrysInRingX->Write();
//   nCrysInRingY->Write();
//   nCrysInRingZ->Write(); 
  ...
  for(int v=0; v<NSlices; v++){
    ...
    //------------------Slices for EB whole ----------------------///
    timeVsAoSigmaEBSlices_[v] ->Write();
  ...
  for(int v=0; v<NSlices; v++){
    //---------------------------Slices of EE All --------------------//
    timeVsAoSigmaEESlices_[v] ->Write();
...
//   // Studies of Crystal time Vs nVertices ? timeVsAoSigmaForEach Crystal With Given Number of Vertices>1
//   timeVsnVerticesEB->GetXaxis()->SetTitle("Time[ns]");
//   timeVsnVerticesEB->GetYaxis()->SetTitle("Number of Vertices");
//   timeVsnVerticesEB->Write();

//   timeVsnVerticesEEP->GetXaxis()->SetTitle("Time[ns]");
//   timeVsnVerticesEEP->GetYaxis()->SetTitle("Number of Vertices");
//   timeVsnVerticesEEP->Write();
 
//   timeVsnVerticesEEM->GetXaxis()->SetTitle("Time[ns]");
//   timeVsnVerticesEEM->GetYaxis()->SetTitle("Number of Vertices");
//   timeVsnVerticesEEM->Write();
...
//     bool IsJet = false;
//     if ( (treeVars_.SCPIdx[bCluster]=100)  &&   (treeVars_.CPIdx[bCluster]=100)   &&   (treeVars_.clusterMom[bCluster]=1) ) IsJet = true;
...
//     else IsJet = false;
 ...
 //     float swissCrossOfThis   = treeVars_.xtalInBCSwissCross[bCluster][thisCry];
	...
	float Ao = ampliOfThis;

	// Variable Bin Size with Energy Filling
       	float eEB = Ao; //*ADCtoGeVEB;        // Amplitude in GeV
	//	float eEB =log10( Ao*ADCtoGeVEB);
	//	float eEBLog = log10(eEB);	
// 	float AoLog = log10(Ao/25);
	//	if(AoLog >0 && AoLog < 1.2){
	  //	  timing = timing - timeCorrectionEB_->Eval(AoLog);
	//	}
	timeVsAoSigmaEB_->Fill(eEB,timing);
	//	timeVsAoSigmaEB_->Fill(Ao,timing);
      	timeVsAoSigmaEBlarge_->Fill(eEB,timing);
	//      timeVsAoSigmaEBlarge_->Fill(Ao,timing);
	// 	timeVsAoSigmaEBlargelog_->Fill(AoLog,timing);
        timeVsAoSigmaEBlargelog_->Fill(eEB,timing);
      
	
	// The slice Filling are done here!

      
    	int v = (int)(floor(eEB*pow(10, -0.3)/10*pow(10,LogStep)));
	//  	int v = (int)(floor((eEB +0.3)/(LogStep+1)));
	 if (v < 0)v = 0;
...
// 	// Add Corrections due to Time Of flight here!
// 	//	float eta = treeVars_.xtalInBCEta[bCluster][thisCry];
// 	float eta = treeVars_.clusterEta[bCluster];
// 	float theta = 2*(TMath::ATan(TMath::Exp(-1*eta)));
//        	float tof =1/(TMath::Cos(theta))*(315/29979245800);
	...
	// Variable Energy Filling for EE
       	float eEE = Ao; //*ADCtoGeVEE;    // Amplitude Runing on GeV
	//	float eEE =log10( Ao*ADCtoGeVEE);

	//   float eEELog = log10(eEE);
	//	float AoLog = log10(Ao/25);
	//	if(AoLog >0 && AoLog < 1.2){
	  //	  timing = timing - timeCorrectionEE_->Eval(AoLog);
	//	}
        timeVsAoSigmaEE_->Fill(eEE,timing);
	//	timeVsAoSigmaEE_->Fill(Ao,timing);
  	timeVsAoSigmaEElarge_->Fill(eEE,timing);
	//	timeVsAoSigmaEElarge_->Fill(Ao,timing);
	timeVsAoSigmaEElargelog_->Fill(eEE,timing);
	//	timeVsAoSigmaEElargelog_->Fill(AoLog,timing);

	//	int v = (int)(floor((eEE+0.3)/LogStep+1)); // since Now we do not have filling with LogA, we need to find equiv of LogStep which is pow(10,LogStep)



	//     Filling the timing for Each SLice Has to be crucial Here! to Match how slices are done!
		//	int v=0;
       	int v = (int)(floor(eEE* pow(10,-0.3)/10*pow(10,LogStep)));

	//	int v = (int)(floor((eEE +0.3)/(LogStep+1)));
       	  if (v < 0)v = 0;
	  	  else if (v > NSlices-1) v = NSlices-1;
	...
	timeVsAoSigmaEElog_->Fill(eEE,timing);
	timeVsAoSigmaEESlices_[v] -> Fill(timing);
    
        
        // fill Jets In EE  Crytals time here  
        Jet1timeEE->Fill(timing);


	  // want  to divide EE in Eta now.
	if( fabs(treeVars_.clusterEta[bCluster]) <1.5){
	  //	timeVsAoSigmaLowEE_->Fill(Ao,timing);
	timeVsAoSigmaLowEE_->Fill(eEE,timing);
	timeVsAoSigmaLowEElog_->Fill(eEE,timing);
        timeVsAoSigmaLowEESlices_[v] -> Fill(timing);
	}
	else 
//	{
	  
	  if(fabs(treeVars_.clusterEta[bCluster])> 1.5  &&  fabs(treeVars_.clusterEta[bCluster])< 1.7){

        //timeVsAoSigmaHighEE_->Fill(Ao,timing); 	
	timeVsAoSigmaHighEE_->Fill(eEE,timing); 
	timeVsAoSigmaHighEElog_->Fill(eEE,timing);
	timeVsAoSigmaHighEESlices_[v] -> Fill(timing);
	
             }
  
  } //end of Encap filling
...
//       thisIsEB = true;
//       //    float sigmaNoiseOfThis=sigmaNoiseEB;
//       // float ampliOverSigOfThis = treeVars_.xtalInBCAmplitudeADC[bCluster][CryInBC] / sigmaNoiseOfThis; 
//       float Crystime  = treeVars_.xtalInBCTime[bCluster][CryInBC]; 

//       int NVerticesEB = treeVars_.nVertices;
//       timeVsnVerticesEB->Fill(Crystime,NVerticesEB);

//       //std::cout<< "Number of Vertices in EB is:" << NVerticesEB << std::endl;
    
//  }
//     else if (treeVars_.xtalInBCIx[bCluster][0] != -999999 && treeVars_.clusterEta[bCluster]>0){ // this is EEP; ix=-999999 tags EB
     
//       thisIsEB = false;
//       //  float sigmaNoiseOfThis=sigmaNoiseEE;
//       // float ampliOverSigOfThis = treeVars_.xtalInBCAmplitudeADC[bCluster][CryInBC] / sigmaNoiseOfThis; 
//       float Crystime  = treeVars_.xtalInBCTime[bCluster][CryInBC]; 

//       int NVerticesEEP = treeVars_.nVertices;
//       timeVsnVerticesEEP->Fill(Crystime,NVerticesEEP);

//       //std:: cout<< "Number of Vertices in EEP is:" << NVerticesEEP << std::endl;
...
//       int NVerticesEEM = treeVars_.nVertices;
//       timeVsnVerticesEEM->Fill(Crystime,NVerticesEEM);
//       // std:: cout<< "Number of Vertices in EEM is:" << NVerticesEEM << std::endl;

//  } // end of last if

//      } // end of loop over crystals 
  
//     } // end of loop over bClusters;
...
//  fitting recHits times in bins of A/sigma, for EB
  ...
  // ----------------Defining Fit for EB All------------------------------// 
 TF1 *gaussEBSlicesFit = new TF1("timeVsAoSigmaEBSlicesFit","gaus",-7,7);



//  TF1 *gaussEBlargelogSlicesFit = new TF1("gaussEBlargelogSlicesFit","gaus",-7,7);
//   TF1 *gaussMod1EBSlicesFit = new TF1("gaussMod1EBSlicesFit","gaus",-7,7);
//   TF1 *gaussMod2EBSlicesFit = new TF1("gaussMod2EBSlicesFit","gaus",-7,7);
//   TF1 *gaussMod3EBSlicesFit = new TF1("gaussMod3EBSlicesFit","gaus",-7,7);
//   TF1 *gaussMod4EBSlicesFit = new TF1("gaussMod4EBSlicesFit","gaus",-7,7);

//   // ----------------Defining Fit for EB All------------------------------// 
//  TF1 *gaussEBSlicesFit = new TF1("gaussEBSlicesFit ","gaus",-7,7);


//Define what you want Bins FitSlices should fit:



//    float binAoLow = 0;
    // float binAoHigh = pow(10,-0.3);

    for(int v=0; v<NSlices; v++){

    //    if (v==0){ binAoLow = 0; binAoHigh = pow(10,-0.3);}

    // else{

      //binAoLow = binAoHigh;

    //   binAoHigh = binAoHigh*pow(10,LogStep);
    //  }

    //----------------------------Fitting for All EB-------------------------//
    if( timeVsAoSigmaEBSlices_[v]->Integral()  >= minEntriesForFit_ ){// do fit for this bin in EB,  require min number entries
      float RMS       = timeVsAoSigmaEBSlices_[v] -> GetRMS();  //isn't this a bug? you never Fit the slices so how do you get the RMS and M?
      float mean      = timeVsAoSigmaEBSlices_[v] -> GetMean();
      //      float area      = timeVsAoSigmaEBSlices_[v] -> GetEntries();
      gaussEBSlicesFit        ->SetParLimits(1,-5,5);  // limit on gaussian central 
      gaussEBSlicesFit        ->SetParameter(1,mean);  // initialize on central value
      gaussEBSlicesFit        ->SetParameter(2,RMS);   // initialize on central value
      timeVsAoSigmaEBSlices_[v] -> Fit("timeVsAoSigmaEBSlicesFit","","",-7,+7); // fit on [-7,+7] ns range to stay away from spikes


//       float EBMean = gaussEBSlicesFit ->GetParameter(1);
//       float EBRMS = gaussEBSlicesFit ->GetParameter(2);
//       float EBMeanErr = gaussEBSlicesFit ->GetParError(1);
//       float EBRMSErr = gaussEBSlicesFit ->GetParError(2);
  
//       fittedMeanVsAoSigmaEB_->SetBinContent(v+1,EBMean);
//       fittedMeanVsAoSigmaEB_->SetBinError(v+1,EBMeanErr);
//       fittedRMSVsAoSigmaEB_->SetBinContent(v+1,EBRMS);
//       fittedRMSVsAoSigmaEB_->SetBinError(v+1,EBRMSErr);

      // why re-initialise on central Value again?
      gaussEBSlicesFit        ->SetParameter(1,0);  // re-initialize on central value
      gaussEBSlicesFit        ->SetParameter(2,1);   // re-initialize on central value
      timeVsAoSigmaEBlog_  ->FitSlicesY(gaussEBSlicesFit,0,-1,0,"R",0);  
      fittedRMSVsAoSigmaEB_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEBlog_2");
      fittedMeanVsAoSigmaEB_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEBlog_1");
      fittedAreaVsAoSigmaEB_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEBlog_0");
      chi2VsAoSigmaEB_       = (TH1D*)gDirectory->Get("timeVsAoSigmaEBlog_chi2");


    }

    // ---------------------Fitting for EB ALL ends--------------------------------///
    ...
    if( timeVsAoSigmaEBlargelogSlices_[v]->Integral()  >= minEntriesForFit_ ){// do fit for this bin in EB,  require min number entries
     ...
     //  float EBlogMean =  gaussEBlargelogSlicesFit ->GetParameter(1);
//       float EBlogRMS =  gaussEBlargelogSlicesFit ->GetParameter(2);
//       float EBlogMeanErr =  gaussEBlargelogSlicesFit ->GetParError(1);
//       float EBlogRMSErr =  gaussEBlargelogSlicesFit ->GetParError(2);
  
//         fittedMeanVsAoSigmaEBlog_->SetBinContent(v+1,EBlogMean);
//         fittedMeanVsAoSigmaEBlog_->SetBinError(v+1,EBlogMeanErr);
//         fittedRMSVsAoSigmaEBlog_->SetBinContent(v+1,EBlogRMS);
//         fittedRMSVsAoSigmaEBlog_->SetBinError(v+1,EBlogRMSErr);
      ...
      timeVsAoSigmaEBlargelog_  ->FitSlicesY(gaussEBlargelogSlicesFit,0,-1,0,"R",0);  
...
//       float EBMod1Mean =   gaussMod1EBSlicesFit->GetParameter(1);
//       float EBMod1RMS =   gaussMod1EBSlicesFit->GetParameter(2);
//       float EBMod1MeanErr =   gaussMod1EBSlicesFit->GetParError(1);
//       float EBMod1RMSErr =   gaussMod1EBSlicesFit->GetParError(2);
  
//          fittedMeanVsAoSigmaMod1EB_->SetBinContent(v+1,EBMod1Mean);
//          fittedMeanVsAoSigmaMod1EB_->SetBinError(v+1,EBMod1MeanErr);
//          fittedRMSVsAoSigmaMod1EB_->SetBinContent(v+1,EBMod1RMS);
//          fittedRMSVsAoSigmaMod1EB_->SetBinError(v+1,EBMod1RMSErr);
      ...
      timeVsAoSigmaMod1EBlog_  ->FitSlicesY(gaussMod1EBSlicesFit,0,-1,0,"R",0);  
...
//       float EBMod2Mean =       gaussMod2EBSlicesFit->GetParameter(1);
//       float EBMod2RMS =       gaussMod2EBSlicesFit->GetParameter(2);
//       float EBMod2MeanErr =       gaussMod2EBSlicesFit->GetParError(1);
//       float EBMod2RMSErr =       gaussMod2EBSlicesFit->GetParError(2);
  
//          fittedMeanVsAoSigmaMod2EB_->SetBinContent(v+1,EBMod2Mean);
//          fittedMeanVsAoSigmaMod2EB_->SetBinError(v+1,EBMod2MeanErr);
//          fittedRMSVsAoSigmaMod2EB_->SetBinContent(v+1,EBMod2RMS);
//          fittedRMSVsAoSigmaMod2EB_->SetBinError(v+1,EBMod2RMSErr);
      ...
      timeVsAoSigmaMod2EBlog_  ->FitSlicesY(gaussMod2EBSlicesFit,0,-1,0,"R",0);  
    ...
    if( timeVsAoSigmaMod3EBSlices_[v]->Integral()  >= minEntriesForFit_ ){// do fit for this bin in EB,  require min number entries
     ...
     //  float EBMod3Mean =      gaussMod3EBSlicesFit->GetParameter(1);
//       float EBMod3RMS =       gaussMod3EBSlicesFit->GetParameter(2);
//       float EBMod3MeanErr =       gaussMod3EBSlicesFit->GetParError(1);
//       float EBMod3RMSErr =       gaussMod3EBSlicesFit->GetParError(2);
  
//          fittedMeanVsAoSigmaMod3EB_->SetBinContent(v+1,EBMod3Mean);
//          fittedMeanVsAoSigmaMod3EB_->SetBinError(v+1,EBMod3MeanErr);
//          fittedRMSVsAoSigmaMod3EB_->SetBinContent(v+1,EBMod3RMS);
//          fittedRMSVsAoSigmaMod3EB_->SetBinError(v+1,EBMod3RMSErr);
      ...
      timeVsAoSigmaMod3EBlog_  ->FitSlicesY(gaussMod3EBSlicesFit,0,-1,0,"R",0);  
...
//       float EBMod4Mean =       gaussMod4EBSlicesFit->GetParameter(1);
//       float EBMod4RMS =       gaussMod4EBSlicesFit->GetParameter(2);
//       float EBMod4MeanErr =       gaussMod4EBSlicesFit->GetParError(1);
//       float EBMod4RMSErr =       gaussMod4EBSlicesFit->GetParError(2);
  
//          fittedMeanVsAoSigmaMod4EB_->SetBinContent(v+1,EBMod4Mean);
//          fittedMeanVsAoSigmaMod4EB_->SetBinError(v+1,EBMod4MeanErr);
//          fittedRMSVsAoSigmaMod4EB_->SetBinContent(v+1,EBMod4RMS);
//          fittedRMSVsAoSigmaMod4EB_->SetBinError(v+1,EBMod4RMSErr);
      ...
      timeVsAoSigmaMod4EBlog_  ->FitSlicesY(gaussMod4EBSlicesFit,0,-1,0,"R",0);  
  ...
  //----------------Defining fit Fxn for EE ALL---------------------------//

 TF1 *gaussEESlicesFit = new TF1("timeVsAoSigmaEESlicesFit","gaus",-7,7);
  for(int v=0; v<NSlices; v++){


//----------------------------Fitting for All EE-------------------------//
    if( timeVsAoSigmaEBSlices_[v]->Integral()  >= minEntriesForFit_ ){// do fit for this bin in EB,  require min number entries
      float RMS       = timeVsAoSigmaEESlices_[v] -> GetRMS();
      float mean      = timeVsAoSigmaEESlices_[v] -> GetMean();
      //      float area      = timeVsAoSigmaEESlices_[v] -> GetEntries();
      gaussEESlicesFit        ->SetParLimits(1,-5,5);  // limit on gaussian central 
      gaussEESlicesFit        ->SetParameter(1,mean);  // initialize on central value
      gaussEESlicesFit        ->SetParameter(2,RMS);   // initialize on central value
      timeVsAoSigmaEESlices_[v] -> Fit("timeVsAoSigmaEESlicesFit","","",-7,+7); // fit on [-7,+7] ns range to stay away from spikes



//       float EEMean =       gaussEESlicesFit->GetParameter(1);
//       float EERMS =       gaussEESlicesFit->GetParameter(2);
//       float EEMeanErr =       gaussEESlicesFit->GetParError(1);
//       float EERMSErr =       gaussEESlicesFit->GetParError(2);
  
//           fittedMeanVsAoSigmaEE_->SetBinContent(v+1,EEMean);
//           fittedMeanVsAoSigmaEE_->SetBinError(v+1,EEMeanErr);
//           fittedRMSVsAoSigmaEE_->SetBinContent(v+1,EERMS);
//           fittedRMSVsAoSigmaEE_->SetBinError(v+1,EERMSErr);



      
      gaussEESlicesFit        ->SetParameter(1,0);  // re-initialize on central value
      gaussEESlicesFit        ->SetParameter(2,1);   // re-initialize on central value
      timeVsAoSigmaEElog_  ->FitSlicesY(gaussEESlicesFit,0,-1,0,"R",0);  
      fittedRMSVsAoSigmaEE_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEElog_2");
      fittedMeanVsAoSigmaEE_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEElog_1");
      fittedAreaVsAoSigmaEE_ = (TH1D*)gDirectory->Get("timeVsAoSigmaEElog_0");
      chi2VsAoSigmaEE_       = (TH1D*)gDirectory->Get("timeVsAoSigmaEElog_chi2");
    }

    // ---------------------Fitting for EE ALL ends--------------------------------///
...
//       float EElargelogMean =        gaussEElargelogSlicesFit->GetParameter(1);
//       float EElargelogRMS =        gaussEElargelogSlicesFit->GetParameter(2);
//       float EElargelogMeanErr =       gaussEElargelogSlicesFit->GetParError(1);
//       float EElargelogRMSErr =       gaussEElargelogSlicesFit->GetParError(2);
  
//            fittedMeanVsAoSigmaEElog_->SetBinContent(v+1,EElargelogMean);
//            fittedMeanVsAoSigmaEElog_->SetBinError(v+1,EElargelogMeanErr);
//            fittedRMSVsAoSigmaEElog_->SetBinContent(v+1,EElargelogRMS);
//            fittedRMSVsAoSigmaEElog_->SetBinError(v+1,EElargelogRMSErr);
      ...
      timeVsAoSigmaEElargelog_  ->FitSlicesY(gaussEElargelogSlicesFit,0,-1,0,"R",0);  
...
//       float EElowMean =       gaussLowEESlicesFit->GetParameter(1);
//       float EElowRMS =        gaussLowEESlicesFit->GetParameter(2);
//       float EElowMeanErr =    gaussLowEESlicesFit->GetParError(1);
//       float EElowRMSErr =     gaussLowEESlicesFit->GetParError(2);
  
//           fittedMeanVsAoSigmaLowEE_->SetBinContent(v+1,EElowMean);
//           fittedMeanVsAoSigmaLowEE_->SetBinError(v+1,EElowMeanErr);
//           fittedRMSVsAoSigmaLowEE_->SetBinContent(v+1,EElowRMS);
//           fittedRMSVsAoSigmaLowEE_->SetBinError(v+1,EElowRMSErr);
      ...
      timeVsAoSigmaLowEElog_  ->FitSlicesY(gaussLowEESlicesFit,0,-1,0,"R",0);  
...
//       float EEhighMean =       gaussHighEESlicesFit->GetParameter(1);
//       float EEhighRMS =       gaussHighEESlicesFit->GetParameter(2);
//       float EEhighMeanErr =       gaussHighEESlicesFit->GetParError(1);
//       float EEhighRMSErr =       gaussHighEESlicesFit->GetParError(2);
  
//         fittedMeanVsAoSigmaHighEE_->SetBinContent(v+1,EEhighMean);
//         fittedMeanVsAoSigmaHighEE_->SetBinError(v+1,EEhighMeanErr);
//         fittedRMSVsAoSigmaHighEE_->SetBinContent(v+1,EEhighRMS);
//         fittedRMSVsAoSigmaHighEE_->SetBinError(v+1,EEhighRMSErr);
      ...
      timeVsAoSigmaHighEElog_  ->FitSlicesY(gaussHighEESlicesFit,0,-1,0,"R",0);  
...
void profilePlot(){ 
  ...
  // TH2F*timeVsAoSigmaMod1EBlog = (TH2F*)f1->Get("single-bias/timeVsAoSigmaMod1EBlog");

int Nbins =(int)timeVsAoSigmaMod1EBlog_->GetNbinsX();
std::vector<float> MeanTime;
std::vector<float> EnergyOfRechit;
 TDirectory *EBMod1ProfilePlots = saving_->mkdir("EB-Mod1-Prof-Plot");

TF1*gausFit = new TF1("gausFit","gaus",-7,7);
gausFit->SetParLimits(1,-5,5);
gausFit->SetParameter(1,0);
gausFit->SetParameter(2,1);

for(int bins = 1; bins <=Nbins; ++bins){
TH1D*thisSlice = (TH1D*)timeVsAoSigmaMod1EBlog_->ProjectionY("",bins, bins,"");
thisSlice->Fit(gausFit);
float Mean = gausFit->GetParameter(1);
//float RMS = gausFit->GetParameter(2);
 float Energy = timeVsAoSigmaMod1EBlog_->GetXaxis()->GetBinUpEdge(bins); // returns Maximum Energy rechit of that bin 
 MeanTime.push_back(Mean);
 EnergyOfRechit.push_back(Energy);
std::string SliceName = "1d Timing For bin";
SliceName +=intToString(bins);
thisSlice->SetName(SliceName.c_str());
EBMod1ProfilePlots->cd();
thisSlice->Write();
 }

 TCanvas *c1 = new TCanvas("c1","ProfileYPlotGraph",200,10,700,500);
float MinEr = 2;
float MaxEr = 1000;
float egy[66];
float mean[66];
for(int i =0; i<Nbins; ++i){
  egy[i] = EnergyOfRechit[i];
  mean[i]= MeanTime[i];
 }
Tgraph = new TGraph(66,egy,mean);
 c1->cd();
 Tgraph->SetFillColor(0);
 Tgraph->GetYaxis()->SetRangeUser(-1.0,1.0);
 Tgraph->GetXaxis()->SetRangeUser(MinEr,MaxEr);
 Tgraph->SetTitle("Fitted Mean For EB Module 1");
 Tgraph->SetName("ProfilePlotGraph");
 Tgraph->Draw("AC*");
}
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------- Fuction to do Single Cluster in Ring Studies of  timing Vs Ring dependence------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//


// void doEtaDependencePlots(){
...
//      //  float Ao = ampliOverSigOfThis;
//   float Eta = fabs(treeVars_.clusterEta[bCluster]);
...
// 	// if ( Eta < 1.8)continue;
//      float timingX = treeVars_.xtalInBCTime[bCluster][thisCry];
//      float ampliOverSigOfThis = treeVars_.xtalInBCAmplitudeADC[bCluster][thisCry] / sigmaNoiseOfThis; 
//      float AoX = ampliOverSigOfThis;
//     nRingX++;
//     //cout << " Number of Xtals in RingX =" << nRingX << endl;

//       timeVsAoSigmaRingX_->Fill( timingX, AoX);

//     nCrysInRingX->Fill(nRingX);
	
//       } 
//       else if ( Eta > 2.1 && Eta < 2.3){
// 	//      if ( Eta < 2.3)continue;
 
//          float timingY = treeVars_.xtalInBCTime[bCluster][thisCry];
//          float ampliOverSigOfThis = treeVars_.xtalInBCAmplitudeADC[bCluster][thisCry] / sigmaNoiseOfThis; 
//          float AoY = ampliOverSigOfThis;
//       nRingY++;
//       //    cout << "Number of Xtals in RingY=" << nRingY << endl;
//    timeVsAoSigmaRingY_->Fill( timingY,AoY);
//    nCrysInRingY->Fill(nRingY);
      
//     } 
//       else if (Eta >2.7 && Eta < 2.9){
// 	//	if (  Eta < 2.9)continue;

//  float timingZ = treeVars_.xtalInBCTime[bCluster][thisCry];
//  float ampliOverSigOfThis = treeVars_.xtalInBCAmplitudeADC[bCluster][thisCry] / sigmaNoiseOfThis; 
//  float AoZ = ampliOverSigOfThis;
// 	nRingZ++;
// 	//  cout << "Number of Xtals in RingZ=" << nRingZ << endl;
//    timeVsAoSigmaRingZ_->Fill(timingZ,AoZ);

//    nCrysInRingZ->Fill(nRingZ);

	
//       }
    
 
//   } //end of loop over Crsytal
//  } // end of loop over bCluster
// } //end of doEtaDependencePlots
